                        ...
                        <CardContent className="p-8 space-y-8">
                            ...
                            <div className="text-center p-8 bg-gradient-to-r from-[#F9FAFB] to-[#1D4ED8]/5 rounded-2xl">
                                ...
                                <p className="text-lg text-[#475569] max-w-3xl mx-auto leading-relaxed">
                                    To create a transformative platform where
                                    cutting-edge research meets practical
                                    innovation, fostering a collaborative
                                    ecosystem that drives technological
                                    advancement and addresses real-world
                                    challenges through AI and data science.
                                </p>
                            </div>
                        </CardContent>
                    </Card>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
                ...
                <p className="text-lg text-[#475569] leading-relaxed">
                    The National Conference on Next-Gen Technologies in AI
                    Applications is a premier academic event that brings
                    together researchers, academicians, industry professionals,
                    and students from around the world to share their latest
                    findings and innovations.
                </p>
                <p className="text-[#475569] leading-relaxed">
                    This conference serves as a global forum to advance academic
                    research and innovation, fostering collaboration between
                    academia and industry. Participants will have the
                    opportunity to present their research, learn about
                    cutting-edge developments, and network with peers in the
                    field.
                </p>
            </div>
                  ...
                  <div className="md:col-span-2 space-y-6">
                      <div>
                          ...
                          <p className="text-lg text-[#475569] leading-relaxed mb-4">
                              ...
                              to JNTUH, accredited by NAAC with A
                              grade and NBA. SNIST has established
                              itself as a leading center for
                              technical education and research in
                              India.
                          </p>
                      </div>
                      <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                      ...
                      <div className="bg-gradient-to-br from-[#F97316]/10 to-[#1D4ED8]/10 p-6 rounded-xl">
                          ...
                          <p className="text-sm text-[#475569] leading-relaxed">
                              ...
                              institution for excellence in
                              technical education, research, and
                              innovation.
                          </p>
                      </div>
                  </div>
    ...
    return (
      ...
      <div className="text-center mb-12">
          ...
          <p className="text-xl text-[#475569] max-w-3xl mx-auto">
              Hear from distinguished researchers who have been
              part of our conference community
          </p>
      </div>
                ...
                <CardContent className="p-8">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-xl opacity-90">
                            Our mission to advance AI research and foster
                            innovation
                        </p>
                    </div>
