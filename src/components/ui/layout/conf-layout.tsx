...
export default function ConferenceLayout({ children, title, subtitle }: ConferenceLayoutProps) {
  ...
  const getActiveLink = (href: string) =>
    pathname === href ? "text-blue-400" : "text-slate-200 hover:text-blue-400"
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <div className="bg-white shadow-sm border-b py-3 px-4">
        <div className="flex items-center justify-center space-x-3 mb-3 lg:mb-0">
          <Image
      ...
      {/* 🔹 Navigation Bar */}
      <nav
        className={`bg-slate-900 shadow-md z-40 transition-all duration-700 ${isLoaded ? "opacity-100" : "opacity-0"}`}
      ...
      >
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between px-4 py-4">
            ...
            {/* 🔸 Title */}
            <Link href="/" className="text-center md:text-left mb-3 md:mb-0">
            ...
            <div className="hidden lg:flex items-center space-x-6">
              {[
                ...
                <Link
                  key={item.path}
                  href={item.path}
                  className={`${getActiveLink(item.path)} transition duration-300 text-sm font-medium`}
                >
                  {item.name}
                </Link>
              ))}
    ...
    <div className="grid md:grid-cols-3 gap-8">
      ...
      <div>
        <h3 className="text-xl font-bold mb-2">
          <span className="text-blue-400">NCNTAIA</span> 2025
        </h3>
      ...
      <div>
        ...
        <p className="text-slate-300">Email: ncntaia-2025@sreenidhi.edu.in</p>
      </div>
      ...
      <div>
        ...
        <p className="text-slate-300">
          ...
          Yamnampet, Ghatkesar Hyderabad - 501 301,<br />
          Telangana.<br />
